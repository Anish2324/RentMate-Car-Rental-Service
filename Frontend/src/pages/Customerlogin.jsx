...
import { FiArrowLeft, FiMail, FiLock, FiEye, FiEyeOff, FiLoader, FiUser } from 'react-icons/fi';
...
const CustomerLogin = () => {
    ...
    const loginCustomer = useCustomerAuthStore((state) => state.loginCustomer);
    const isCustomerLoggedIn = useCustomerAuthStore((state) => state.isCustomerLoggedIn);
    const isVerified = useCustomerAuthStore((state) => state.isCustomerVerified);
    ...
    }, [isCustomerLoggedIn, isVerified, navigate]);
                ...
                {!securityCheck && (
                    ...
                    >
                        <div className="text-center p-8 max-w-md">
                            ...
                            >
                                <FiUser className="w-full h-full text-green-400" />
                            </motion.div>
                            <h3 className="text-2xl font-bold text-white mb-2">Customer Portal Security Check</h3>
            ...
            >
                ...
                >
                    ...
                    <motion.div variants={itemVariants} className="mb-8 text-center">
                        ...
                        <h2 className="text-3xl font-bold text-white">Customer Portal</h2>
                        <p className="text-gray-400 mt-1">Access your personalized experience</p>
                    </motion.div>
                        ...
                        <motion.div variants={itemVariants}>
                            ...
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    className="pl-10 input input-bordered w-full bg-gray-700 border-gray-600 text-white placeholder-gray-500 focus:ring-2 focus:ring-green-500 focus:border-green-500 transition-all duration-300"
                    ...
                    <motion.div className="mt-6 text-center space-y-3" variants={containerVariants}>
                        ...
                        <motion.div variants={itemVariants} className="pt-4 border-t border-gray-700">
                            <p className="text-gray-400 text-sm mb-2">New customer?</p>
                            <button
                                type="button"
                                className="btn btn-ghost text-lime-400 hover:text-lime-300 border border-gray-700 hover:border-gray-600 w-full py-2 text-sm font-medium transition-all duration-200"
